...
int main(int argc, char* argv[]) {
    ...
    printf("\n\n\n\n\n---------------------------\n\n");
    usleep(2);
    read(fd2,data1,sizeof(*data1));
    printf("\n\n\n\n\n---------------------------\n\n");
    printf("\n data:%s number of messages recieved: %d\n",data1->g,data1->x); 
    printf("\n\n\n\n\n---------------------------\n\n");
    usleep(2);
  
    read(fd2, &delay, sizeof(delay));
    printf("\n\n\n\n\n---------------------------\n\n");
    ...
    printf("\n\n\n\n\n---------------------------\n\n");
    usleep(2);
    read(fd2, &avg, sizeof(avg));
    usleep(2);
    read(fd2, &avg1, sizeof(avg1));
    usleep(2);
    //lat in microseconds
    lat=((avg)+(avg1))/2;
